...
class ParentsPersonalInfoScreen extends StatefulWidget {
  const ParentsPersonalInfoScreen({super.key});

  @override
  State<ParentsPersonalInfoScreen> createState() => _ParentsPersonalInfoScreenState();
}

class _ParentsPersonalInfoScreenState extends State<ParentsPersonalInfoScreen> {
  ...
  void _goNext() {
    ...
    Navigator.pushNamed(
      context,
      AppRouter.connectedchild,
      arguments: ParentRegistrationDraft(
                    ...
                    child: Column(
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(context.tr("Let's get to know you! Enter your details to start setting up your parent profile."),
                            textAlign: TextAlign.center,
